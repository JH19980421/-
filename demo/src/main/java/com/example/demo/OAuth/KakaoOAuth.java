...
import com.example.demo.OAuth.response.KakaoOAuthToken;
import com.example.demo.OAuth.response.KakaoUser;
...
public class KakaoOAuth implements SocialOAuth {
    ...
    public KakaoOAuthToken getAccessToken(ResponseEntity<String> response) throws JsonProcessingException {
        ...
        System.out.println("AccessToken: " + kakaoOAuthToken.getAccess_token());
